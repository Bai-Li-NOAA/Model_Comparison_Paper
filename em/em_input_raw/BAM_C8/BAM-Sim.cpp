...
cout << endl;
  ...
  set_selpar_A501_fleet1_B1.allocate(1,7,"set_selpar_A501_fleet1_B1");
  set_selpar_slope1_fleet1_B1.allocate(1,7,"set_selpar_slope1_fleet1_B1");
  set_selpar_A502_fleet1_B1.allocate(1,7,"set_selpar_A502_fleet1_B1");
  set_selpar_slope2_fleet1_B1.allocate(1,7,"set_selpar_slope2_fleet1_B1");
  set_selpar_A501_fleet1_B2.allocate(1,7,"set_selpar_A501_fleet1_B2");
  set_selpar_slope1_fleet1_B2.allocate(1,7,"set_selpar_slope1_fleet1_B2");
  set_selpar_A502_fleet1_B2.allocate(1,7,"set_selpar_A502_fleet1_B2");
  set_selpar_slope2_fleet1_B2.allocate(1,7,"set_selpar_slope2_fleet1_B2");
  set_selpar_A501_survey1.allocate(1,7,"set_selpar_A501_survey1");
  set_selpar_slope1_survey1.allocate(1,7,"set_selpar_slope1_survey1");
  set_selpar_A502_survey1.allocate(1,7,"set_selpar_A502_survey1");
  set_selpar_slope2_survey1.allocate(1,7,"set_selpar_slope2_survey1");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #endif
  selpar_A501_survey1.allocate(selpar_A501_survey1_LO,selpar_A501_survey1_HI,selpar_A501_survey1_PH,"selpar_A501_survey1");
  selpar_slope1_survey1.allocate(selpar_slope1_survey1_LO,selpar_slope1_survey1_HI,selpar_slope1_survey1_PH,"selpar_slope1_survey1");
  selpar_A502_survey1.allocate(selpar_A502_survey1_LO,selpar_A502_survey1_HI,selpar_A502_survey1_PH,"selpar_A502_survey1");
  selpar_slope2_survey1.allocate(selpar_slope2_survey1_LO,selpar_slope2_survey1_HI,selpar_slope2_survey1_PH,"selpar_slope2_survey1");
  selpar_A501_survey1_out.allocate(1,8,"selpar_A501_survey1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A501_survey1_out.initialize();
  #endif
  selpar_slope1_survey1_out.allocate(1,8,"selpar_slope1_survey1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope1_survey1_out.initialize();
  #endif
  selpar_A502_survey1_out.allocate(1,8,"selpar_A502_survey1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_survey1_out.initialize();
  #endif
  selpar_slope2_survey1_out.allocate(1,8,"selpar_slope2_survey1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope2_survey1_out.initialize();
  #endif
  ...
  #endif
  selpar_A501_fleet1_B1.allocate(selpar_A501_fleet1_B1_LO,selpar_A501_fleet1_B1_HI,selpar_A501_fleet1_B1_PH,"selpar_A501_fleet1_B1");
  selpar_slope1_fleet1_B1.allocate(selpar_slope1_fleet1_B1_LO,selpar_slope1_fleet1_B1_HI,selpar_slope1_fleet1_B1_PH,"selpar_slope1_fleet1_B1");
  selpar_A502_fleet1_B1.allocate(selpar_A502_fleet1_B1_LO,selpar_A502_fleet1_B1_HI,selpar_A502_fleet1_B1_PH,"selpar_A502_fleet1_B1");
  selpar_slope2_fleet1_B1.allocate(selpar_slope2_fleet1_B1_LO,selpar_slope2_fleet1_B1_HI,selpar_slope2_fleet1_B1_PH,"selpar_slope2_fleet1_B1");
  selpar_A501_fleet1_B2.allocate(selpar_A501_fleet1_B2_LO,selpar_A501_fleet1_B2_HI,selpar_A501_fleet1_B2_PH,"selpar_A501_fleet1_B2");
  selpar_slope1_fleet1_B2.allocate(selpar_slope1_fleet1_B2_LO,selpar_slope1_fleet1_B2_HI,selpar_slope1_fleet1_B2_PH,"selpar_slope1_fleet1_B2");
  selpar_A502_fleet1_B2.allocate(selpar_A502_fleet1_B2_LO,selpar_A502_fleet1_B2_HI,selpar_A502_fleet1_B2_PH,"selpar_A502_fleet1_B2");
  selpar_slope2_fleet1_B2.allocate(selpar_slope2_fleet1_B2_LO,selpar_slope2_fleet1_B2_HI,selpar_slope2_fleet1_B2_PH,"selpar_slope2_fleet1_B2");
  selpar_A501_fleet1_B1_out.allocate(1,8,"selpar_A501_fleet1_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A501_fleet1_B1_out.initialize();
  #endif
  selpar_slope1_fleet1_B1_out.allocate(1,8,"selpar_slope1_fleet1_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope1_fleet1_B1_out.initialize();
  #endif
  selpar_A502_fleet1_B1_out.allocate(1,8,"selpar_A502_fleet1_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_fleet1_B1_out.initialize();
  #endif
  selpar_slope2_fleet1_B1_out.allocate(1,8,"selpar_slope2_fleet1_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope2_fleet1_B1_out.initialize();
  #endif
  selpar_A501_fleet1_B2_out.allocate(1,8,"selpar_A501_fleet1_B2_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A501_fleet1_B2_out.initialize();
  #endif
  selpar_slope1_fleet1_B2_out.allocate(1,8,"selpar_slope1_fleet1_B2_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope1_fleet1_B2_out.initialize();
  #endif
  selpar_A502_fleet1_B2_out.allocate(1,8,"selpar_A502_fleet1_B2_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_fleet1_B2_out.initialize();
  #endif
  selpar_slope2_fleet1_B2_out.allocate(1,8,"selpar_slope2_fleet1_B2_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope2_fleet1_B2_out.initialize();
  #endif
