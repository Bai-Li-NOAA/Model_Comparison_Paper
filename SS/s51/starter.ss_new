...
35 # max yr for sdreport outputs (-1 for endyr; -2 for endyr+Nforecastyrs
...
0.01 # MCMC output detail: integer part (0=default; 1=adds obj func components); and decimal part (added to SR_LN(R0) on first call to mcmc)
