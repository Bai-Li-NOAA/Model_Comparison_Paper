...
om_sim_num <- 200 # total iterations per case
...
f_matrix <- f_case(f_pattern=6, f_min=NULL, f_max=NULL, f_end=NULL, f_mean=0.39, start_val=0.01, start_year=6, nyr=nyr, om_sim_num=om_sim_num, f_dev_matrix=f_dev_matrix)
