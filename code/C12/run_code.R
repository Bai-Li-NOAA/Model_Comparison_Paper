...
list_of_packages <- c("rstudioapi", "gdata", "PBSadmb", "stringr", "matrixcalc", "r4ss", "ASAPplots", "readxl", "scales", "corrplot", "glue")
...
f_dev_matrix <- cbind(rep(0, nrow(f_dev_matrix)), f_dev_matrix)

nyr=31
f_matrix <- f_case(f_pattern=7, f_min=0.01, f_max=0.39, f_end=NULL, f_mean=NULL, start_val=0, start_year=2, nyr=nyr, om_sim_num=om_sim_num, f_dev_matrix=f_dev_matrix)
